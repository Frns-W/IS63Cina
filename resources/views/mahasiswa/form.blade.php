        ...
        <div class="card-body">
            <form method="POST" action="/mahasiswa">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nim') is-invalid @enderror" id="exampleInputEmail1"
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="jenis_kelamin" id="radioDefault1"
                            value="Perempuan">
                        <label class="form-check-label" for="radioDefault1">Perempuan</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="jenis_kelamin" id="radioDefault2"
                            value="Laki-laki" checked>
                        <label class="form-check-label" for="radioDefault2">Laki-Laki</label>
                    </div>
                    @error('jenis_kelamin')
                        <div class="alert">
                            {{ $message }}
